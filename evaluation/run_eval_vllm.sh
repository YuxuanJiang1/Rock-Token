#!/bin/bash
# run_eval_vllm.sh — TOPD model eval on AIME24/25/HMMT using vLLM
...
MODEL=/p/work2/yuxuanj1/opd/KDFlow/output/topd_offpolicy20k_onpolicy_5k/epoch_1
EVAL_OUT=/p/work2/yuxuanj1/opd/eval_results/topd_vllm
...
echo "============================================================"
echo "  TOPD vLLM Eval  $(date)"
echo "  Model: topd_offpolicy20k_onpolicy_5k/epoch_1"
echo "  Tasks: ${TASKS}"
...
print("\n=== TOPD Model — 3-Run Benchmark Summary ===")
print(f"  Model : topd_offpolicy20k_onpolicy_5k/epoch_1")
