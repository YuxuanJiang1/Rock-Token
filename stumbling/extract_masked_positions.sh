...
# (kdflow/algorithms/token_freeze_kd.py:99). This script just greps that line
# out of each run's training log, sums hits and totals across every logged
# microbatch, and reports hits/total as a percentage -- the real, empirically
# observed masking rate for that run, not a theoretical estimate.
#
