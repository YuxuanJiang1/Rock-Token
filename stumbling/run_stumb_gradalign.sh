#!/usr/bin/env bash
# W4 ablation (Reviewer RNAB): freeze the top-K tokens by cosine alignment
# with G_balanced (Sec. 2.6 / Fig. 3 quantity) instead of the Rock Score --
# tests whether a purely gradient-alignment-based selection gives the same
# efficiency/accuracy tradeoff as Rock-Freeze.
# Token list built by build_ablation_freeze_lists.py -> top_gradalign.json.
#
...
SAVE_DIR=/umbc/rs/pi_ferraro/ada/users/sroydip1/collab/Rock-Token-checkpoints/top_gradalign
